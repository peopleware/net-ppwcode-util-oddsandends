...
namespace PPWCode.Util.OddsAndEnds.I.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        /// <returns>This method returns a date.</returns>
        [Pure]
        ...
        /// <summary>
        ///     Returns the amount of days between the given dates.
        /// </summary>
        ...
        /// <returns>An Integer representing the number of days.</returns>
        [Pure]
        ...
        /// <returns>The difference in months between the given dates.</returns>
        [Pure]
        ...
        /// <param name="startDate">The start date.</param>
        /// <param name="endDate">The end date.</param>
        /// <returns>The difference in quarters between the given dates.</returns>
        [Pure]
        ...
        /// <summary>
        ///     This method returns the number of days in the year of the given date.
        /// </summary>
        /// <param name="when">The given date.</param>
